  ...
  <body>
    ...
    <header class="site-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-4 site-logo" data-aos="fade"><a href="index.jsp"><em>Villa</em></a></div>
          <div class="col-8">
          ...
          <div class="col-md-5">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                ...
                <p><span class="d-block">Email:</span> <span> webadmin@gmail.com</span></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            <p><span class="d-block">Address:</span> <span>309 Dampe,Pitipana Rd <br>Hoamagama</span></p>
            <p><span class="d-block">Phone:</span> <span>+94777777777</span></p>
            <p><span class="d-block">Email:</span> <span> webadmin@gmail.com</span></p>
          </div>
          <div class="col-md-3 mb-5">
